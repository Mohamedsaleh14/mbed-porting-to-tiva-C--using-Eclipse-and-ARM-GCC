...
//
#define CLOCK_SETUP 1		//DONE CHECKING
...
//
#define CFG_RCC_SYSDIV 2		//DONE CHECKING
...
//
#define CFG_RCC_USESYSDIV 1		//DONE CHECKING
...
//
#define CFG_RCC_USEPWMDIV 1		//DONE CHECKING
...
// above.
//
#define CFG_RCC_PWMDIV 7		//DONE CHECKING
...
// set to 0.
//
#define CFG_RCC_PWRDN 0			//DONE CHECKING
...
//
#define CFG_RCC_BYPASS 0		//DONE CHECKING
...
//
#define CFG_RCC_XTAL 21		//DONE CHECKING
...
// the comments above.
//
#define CFG_RCC_OSCSRC 0	//DONE-CHECKING
...
//
#define CFG_RCC_IOSCDIS 1		//DONE CHECKING
...
//
#define CFG_RCC_MOSCDIS 0		//DONE CHECKING
...
//
#define CFG_RCC2_USERCC2 1		//DONE CHECKING
...
//
#define CFG_RCC_SYSDIV2 3		//DONE CHECKING
...
// set to 0.
//
#define CFG_RCC_PWRDN2 0		//DONE CHECKING
...
// this to 0 if you are using the PLL.
//
#define CFG_RCC_BYPASS2 0		//DONE CHECKING
...
// the comments above.
//
#define CFG_RCC_OSCSRC2 0		//DONE CHECKING
  ...
  //  if (rcc2 & SYSCTL_RCC2_BYPASS2)
      ...
      if (rcc & (1UL<<22)) {                            /* check USESYSDIV */
        if (rcc2 & (1UL<<11)) {
          ...
          SystemCoreClock = SystemCoreClock / (((rcc2>>22) & (0x3F)) + 1);
        }
      }
    } else {
  //    if (RCC_Val & (1UL<<11)) {                            /* check BYPASS */
